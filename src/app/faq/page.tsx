  ...
  return (
    <>
      ...
      <div className="mx-auto flex min-h-screen w-screen flex-col items-center justify-center bg-primary pt-36">
        <div className="mb-8 text-6xl text-white drop-shadow-[0_0_10px_rgba(1,234,249,0.8)]">FAQ</div>
        <section className="w-1/2 divide-y divide-slate-200 rounded bg-fourth shadow-md shadow-slate-200">
          <details className="group p-4">
            ...
            <p className="mt-4 text-zinc-400">
              All components can be copied and pasted and easily implemented in your tailwind css projects. You can choose which language
              you want to copy the desired component and just hover and click on the component you need and paste it on your project.
            </p>
          </details>
          <details className="group p-4">
            <summary className="relative flex cursor-pointer list-none gap-4 pr-8 font-medium text-white transition-colors duration-300 focus:text-secondary focus-visible:outline-none group-hover:text-secondary  [&::-webkit-details-marker]:hidden">
            ...
            <p className="mt-4 text-zinc-400">
              All components come with proper attributes to ensure full accessibility with the WAI-ARIA standards. Web accessibility means
          ...
          <details className="group p-4">
            ...
            <p className="mt-4 text-zinc-400">Every component is fully responsive and implemented to look great at any screen size.</p>
          </details>
          <details className="group p-4">
            <summary className="relative flex cursor-pointer list-none gap-4 pr-8 font-medium text-white transition-colors duration-300 focus:text-secondary focus-visible:outline-none group-hover:text-secondary  [&::-webkit-details-marker]:hidden">
              <svg
            ...
            <p className="mt-4 text-zinc-400">
              Our team has used the currently latest TailwindCSS version. The code is used in its original form without any customization or
