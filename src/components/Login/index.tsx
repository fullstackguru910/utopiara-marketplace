...
export default function Login({ isShowing, setIsShowing, setIsShowing1 }: LoginProps) {
    ...
    <div
      ...
      <div
        ...
        <header
          ...
          <h3 className="mb-10 flex-1 text-2xl font-medium text-white">Welcome back!</h3>
          <button
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="relative my-6">
              ...
              <small className="absolute flex w-full justify-between px-4 py-1 text-xs text-slate-400 transition peer-invalid:text-pink-500">
                ...
                <div className="cursor-pointer hover:text-secondary">Forget your password?</div>
              </small>
            </div>
            <Checkbox />
          </div>
