  ...
  <StyledWrapper>
    <div className="buttons text-primary">
      ...
      <button
        ...
        style={{ transitionDelay: '0s, 0s, 0s', transitionProperty: 'translate, background, box-shadow' }}>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
          fill="currentColor"
      ...
      <button
        ...
        style={{ transitionDelay: '0.6s, 0s, 0.6s', transitionProperty: 'translate, background, box-shadow' }}>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
          fill="currentColor"
      ...
      <button
        ...
        style={{ transitionDelay: '0.7s, 0s, 0.7s', transitionProperty: 'translate, background, box-shadow' }}>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
          fill="currentColor"
...
const StyledWrapper = styled.div`
  ...
  .button {
    ...
    background: #e8e8e8;
    box-shadow:
      2px 2px 6px rgba(202, 202, 202, 0),
