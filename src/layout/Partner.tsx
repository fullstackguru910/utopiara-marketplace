    ...
    <div
      ...
      <div className="relative z-10 mx-auto flex h-full w-[80%] flex-col items-center justify-between">
        <h1 className="lg:animate-partner group absolute z-10 text-center font-bold text-white max-lg:left-0 max-lg:top-12  max-lg:text-2xl lg:left-12 lg:top-64 lg:text-[48px]">
          <span className="text-secondary  group-hover:drop-shadow-[0_0_10px_rgba(1,234,249,0.8)]">CREATE</span>{' '}
          <span className="text-white group-hover:drop-shadow-[0_0_10px_rgba(255,255,255,0.8)]">AND</span>
          <br /> <span className="text-secondary group-hover:drop-shadow-[0_0_10px_rgba(1,234,249,0.8)]">MINT</span>{' '}
          <span className="text-white group-hover:drop-shadow-[0_0_10px_rgba(255,255,255,0.8)]">NFTS</span>
        </h1>
